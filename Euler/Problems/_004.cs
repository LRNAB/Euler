...
namespace Euler.Problems
{
    ...
    public class _004 : IProblem
    {
        ...
        public String Solve()
        {
            ...
            return String.Format("The largest palindrome made from the product of two 3-digit numbers is {0}", palindromes.Max());
        }
    }
}